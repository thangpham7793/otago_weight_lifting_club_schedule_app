...
var InstructorService = (function () {
    ...
    InstructorService.prototype.checkCredentials = function (req, _, next) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        return [4, (0, bcrypt_1.compare)(password, hashedPassword)];
                    case 2:
                        isValidPassword = _c.sent();
                        if (!isValidPassword) return [3, 4];
                        return [4, (0, register_1.makeToken)({ instructorId: instructorId })];
                    case 3:
                        token = _c.sent();
    ...
    InstructorService.prototype.changeInstructorPassword = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = req.body, newPassword = _a.newPassword, email = _a.email;
