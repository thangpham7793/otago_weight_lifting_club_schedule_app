...
62	Oliver	Rohtmets	Dicksono@kavanagh.school.nz	80.00	107.00	101.00	101.00	130.00	113.00	90.00	1	rohtmetso
...
SELECT pg_catalog.setval('public."schedule_scheduleId_seq"', 196, true);
