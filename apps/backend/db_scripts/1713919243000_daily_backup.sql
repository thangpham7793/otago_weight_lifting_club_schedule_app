...
62	Oliver	Rohtmets	Dicksono@kavanagh.school.nz	78.00	107.00	88.00	88.00	118.00	100.00	80.00	1	rohtmetso
...
SELECT pg_catalog.setval('public."schedule_scheduleId_seq"', 193, true);
